...
export default function FormCard(props) {
  ...
  const createEventSubmit = async (event) => {
    ...
    try {
      await registerEvent(name, type, "Microsoft", quantity, date, price, description);
      setErro(null);
      history.push('/');
    ...
    <>
      ...
      <Container>
        ...
        <InputText 
          ...
          id='eventTicketNumber' {...register("quantity")}
        />
        ...
        <InputText
          ...
          id='priceByTicket' {...register("price")}
        />
